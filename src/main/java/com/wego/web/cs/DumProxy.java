...
public class DumProxy {
	...
	public String makeBirthyear() {
	       int a = 1950,b = 2019;
	      BiFunction<Integer,Integer,Integer> f = (t,u)->(int)(Math.random()*(u-t))+t;
	         return String.valueOf(f.apply(a, b));
	      }
	public String makeBirthmonth() {
	          int iMinMonth = 1;
	          int iMaxMonth = 12;
	          int iRandomMonth = (int)(Math.random() * iMaxMonth - iMinMonth + 1) + iMinMonth;
	         return String.valueOf(iRandomMonth);
	      }
	public String makeBirthday() {
	          int[] maxDays = {31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31};
	          int iRandomDay = (int)(Math.random() * (Integer.parseInt(makeBirthmonth()) -2) + 2);
	         return String.valueOf(iRandomDay);
	      }
	...
	public User makeUser(){
		return new User(makeUserid(),makeUserpwd(),makeUsername(),makeNickname(),makeBirthyear(),makeBirthmonth(),makeBirthday(),makeTelephone(),makePetType());
	}
	@Transactional
