...
public class ReviewController {
	...
	public void commentdelete(@PathVariable String commentno){
		System.out.println("코멘트 삭제 컨트롤러");
		reviewMapper.commentdelete(commentno);
	...
	public void delete(@PathVariable String artseq) {
		System.out.println("삭제컨트롤러");
		reviewMapper.delete(artseq);
	}
	...
	public Map<?,?> update(@RequestBody Review param,@PathVariable String artseq){
		HashMap<String,String> map = new HashMap<>();
		System.out.println("업뎃컨트롤러");
		reviewMapper.update(param);
		map.put("msg", "success");
		return map;
