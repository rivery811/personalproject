			...
			<form name="registerform">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5"style="display: flex;" >
						<input id="birthyear" style="width:100px" type="text" class="form-control"  maxlength="10" value=""><p style="padding-right: 10px;">년 </p>
						<input id="birthmonth" style="width:100px"type="text" class="form-control"  maxlength="10" value=""><p style="padding-right: 10px;">월</p>
						<input id="birthday" style="width:100px"type="text" class="form-control"  maxlength="10" value=""><p>일</p>
					</div>
				</div>
